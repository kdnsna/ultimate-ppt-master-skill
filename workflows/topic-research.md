...
- [ ] **Next**: SKILL.md Step 2 →
  ...
  `project_manager.py import-sources projects/<project_name> projects/<topic_slug>.md projects/<topic_slug>/*.* --move`  # repo-internal research artifacts; user originals still default to --copy
```
