...
for (const item of secondaryCases) {
  ...
  if (report.releaseVersion !== '6.3.9' || report.releaseStatus !== 'github-released') {
    errors.push(`${item.dir}: quality report must distinguish its stable schema from the current GitHub release`);
  }
  if (report.releaseEvidence !== 'https://github.com/kdnsna/ultimate-ppt-master-skill/releases/tag/v6.3.9'
...
const benchmarkMarkers = [
  '<html lang="zh-CN">',
  'v6.3.9 正式版本',
  'https://github.com/kdnsna/ultimate-ppt-master-skill/releases/tag/v6.3.9',
  '先看成品，',
  '再看交付证据。',
  '脱敏经营复盘',
  '可编辑 PPTX',
