...
for (const item of secondaryCases) {
  ...
  if (report.releaseVersion !== '7.0.0' || report.releaseStatus !== 'unreleased') {
    errors.push(`${item.dir}: quality report must distinguish its stable schema from the current GitHub release`);
  }
  if (report.releaseEvidence !== 'https://github.com/kdnsna/ultimate-ppt-master-skill/pull/15'
...
const benchmarkMarkers = [
  '<html lang="zh-CN">',
  'v7.0.0 候选版本',
  'https://github.com/kdnsna/ultimate-ppt-master-skill/pull/15',
  '先看成品，',
  '再看交付证据。',
  '脱敏经营复盘',
  '可编辑 PPTX',
