...
> 从真实资料出发，在本地完成一份可编辑、可审阅、能放心交付的演示文稿。已有 PPT？先用 [PPTLint](https://github.com/kdnsna/pptlint) 检查。
<p align="center">
...
uvx pptlint check <final.pptx> --profile ai-generated # 案例：https://kdnsna.github.io/pptlint/
```

旧 `decklint` 命令通过 PPTLint 兼容到 v0.4；所有新接入请使用 `pptlint`。
