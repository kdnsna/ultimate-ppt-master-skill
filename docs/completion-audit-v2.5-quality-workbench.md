...
| Skill marketplace distribution is prepared | `agents/openai.yaml`, `agents/marketplace-listing.json`, `assets/skill-market/*`, and `docs/skill-market-distribution.md` | Complete |
...
| Release gates include quality and marketplace checks | `docs/release-maintenance.md`, `.github/workflows/ci.yml`, and `package.json` scripts | Complete |
