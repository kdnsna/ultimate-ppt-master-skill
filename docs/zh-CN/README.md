...
Ultimate PPT Master v4.2 采用分类文档结构。先按你当前要做的事情选择入口。
...
| 需求 | 阅读 |
|---|---|
| 查看最新发布 | [发布说明 - v4.2.0](./release/release-notes-v4.2.0.md) |
...
v4.2 的新增重点是：先用 DeckIR 页面地图和 source-map 锁定结构与证据，再进入 page recipes、可编辑生成和渲染审阅；v4.0 的视觉契约仍负责阻止重复模板和正式正文页整页图片化。
