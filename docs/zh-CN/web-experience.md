...
v2.4.0 起，首页继续用通俗语言解释 Bridge、Agent、API key 和 handoff，并把工作台拆成开始、资料与目标、配置检测、交给 AI 助手、预览与文件等菜单页。配置页提供一键检测，用于检查本机 Bridge、已安装 Agent 和 provider 状态；内容预设区会显示 starter pack 路径、模板候选和更具体的质量检查。
