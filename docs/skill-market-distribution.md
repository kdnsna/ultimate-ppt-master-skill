...
| Proof cases | `README.md#v25-case-carousel`, `apps/web/public/benchmark/index.html`, and `docs/quality-workbench-v2.5.md` |
| Install guide | `docs/agent-setup.md` |
...
- README first screen shows the quickstart, proof carousel, and skill-market link.
...
- Release checklist runs `npm run audit:presets`, `npm run audit:quality`, `npm run audit:market`, `npm run test:node`, `npm run test:worker`, and `npm run build:web`.
