...
Developer setup lives in [Quickstart Desktop](./quickstart-desktop.md). Signing, notarization, and Homebrew work live in [Release and Maintenance](../release/release-maintenance.md) and [Homebrew Distribution Plan](../release/homebrew-distribution.md).
