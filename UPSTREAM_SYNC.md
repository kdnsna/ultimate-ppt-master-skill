...
- `baoyu-cover-image`, `baoyu-xhs-images`, `baoyu-diagram`, and `baoyu-image-gen` are candidates for optional future modules, not production-critical dependencies for v5.3.x.
