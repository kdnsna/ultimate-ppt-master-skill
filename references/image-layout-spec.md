...
**When to run**: if image approach includes "B) User-provided", run the scan and populate the image resource list during the Strategist's one delivery brief, before final content outlining.
